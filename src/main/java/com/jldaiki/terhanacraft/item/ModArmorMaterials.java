...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    //armor properties
    GLACIUS("glacius", 15, new int[]{3, 5, 6, 3}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.of(new ItemLike[]{Items.IRON_INGOT});


    });
    //13=boots,15=leggings,16=chestplate,11=helmet
    ...
    public String getName() {
        return Terhanacraft.MOD_ID + ":" + this.name;
    }
